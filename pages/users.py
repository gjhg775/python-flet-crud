        ...
        controls=[
            ...
            ft.Container(
                ...
                content=ft.ResponsiveRow([
                    ...
                    ft.Column(col={"xs":0, "sm":0, "md":0, "lg":1, "xl":3, "xxl":4}),
                    ft.Column(col={"xs":12, "sm":6, "md":7, "lg":5, "xl":5, "xxl":3}, controls=[lblUsuarios, buscar, tblUsuarios], alignment=ft.alignment.center_right),
                    ft.Column(col={"xs":12, "sm":6, "md":5, "lg":5, "xl":3, "xxl":2}, controls=[lblAccesos, tblAccesos]),
                    ft.Column(col={"xs":0, "sm":0, "md":0, "lg":1, "xl":1, "xxl":3}),
                ]),
                # ]),
            ),
