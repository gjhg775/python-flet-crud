        ...
        controls=[
            ...
            ft.Container(
                ...
                content=ft.ResponsiveRow([
                    ...
                    ft.Column(col={"xs":12, "sm":7, "md":7, "lg":7, "xl":7, "xxl":5}, controls=[lblUsuarios, buscar, tblUsuarios], alignment=ft.alignment.center_right),
                    ft.Column(col={"xs":12, "sm":5, "md":5, "lg":3, "xl":3, "xxl":3}, controls=[lblAccesos, tblAccesos]),
                    ft.Column(col={"xs":0, "sm":0, "md":0, "lg":1, "xl":1, "xxl":2}),
                ]),
                # ]),
            ),
