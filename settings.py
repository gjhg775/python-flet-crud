...
global username, photo, user_avatar, user_photo, usuario, acceso_configuracion, acceso_variables, acceso_registro, acceso_cuadre, acceso_cierre, textsize, fieldwith, sw, preview_register, print_register_receipt, preview_cash, print_cash_receipt, printer, paper_width, prefijo, cliente_final, progressRing
